...
Построим графики зависимости количества эпох от ошибки обучения в Google Sheets, взяв за основные данные результаты, полученные в результате проведенных нами операций обучения:
...
В третьем задании я реализовала смену цветов различных шаров в соответствии с результатами логических операций.
...
- 4 шара двух цветов - два из них, дальние жёлтый и розовый, будут следовать по принципу, изученному перцептроном, "ИЛИ", а два других будут действовать по принципу "И". Все шары обладают компонентом Rigidbody, в настройках которого указано, что они подвержены гравитации:
...
В скрипте мы указываем цифровые значения для двух цветов, в которые мы окрашиваем шары и триггер: 
